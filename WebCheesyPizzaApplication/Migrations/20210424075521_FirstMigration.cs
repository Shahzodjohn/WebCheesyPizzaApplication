...
namespace WebCheesyPizzaApplication.Migrations
{
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketProducts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "Image", "Name", "Price", "Reciept" },
                values: new object[] { 1, 1, null, "/images/burger.jpg", "Гамбургер", 12.0, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketProducts_CategoryId",
                table: "BasketProducts",
                column: "CategoryId");
